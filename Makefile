...
all: engine_v1 engine_v2 engine_v3 engine_v4 engine_v5 single_check multi_check
...
sanitize: engine_v1_asan engine_v2_asan engine_v3_asan engine_v4_asan engine_v5_asan

thread-sanitize: engine_v1_tsan engine_v2_tsan engine_v3_tsan engine_v4_tsan engine_v5_tsan
...
clean:
	rm -f engine_v1 engine_v2 engine_v3 engine_v4 engine_v5 single_check multi_check
	rm -f engine_v1_asan engine_v2_asan engine_v3_asan engine_v4_asan engine_v5_asan
	rm -f engine_v1_tsan engine_v2_tsan engine_v3_tsan engine_v4_tsan engine_v5_tsan
